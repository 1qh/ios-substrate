...
private func iosxCommandSmokeArguments() -> [(String, [String])] {
    [
        ...
        ("lint editorconfig", ["lint", "editorconfig", "--version"]),
        ("lint yamllint", ["lint", "yamllint", "--version"]),
        ("lint taplo", ["lint", "taplo", "--version"]),
        ("lint taplo-format", ["lint", "taplo-format", "--version"]),
        ("lint lychee", ["lint", "lychee", "--version"]),
        ("fmt shfmt", ["fmt", "shfmt", "--version"]),
